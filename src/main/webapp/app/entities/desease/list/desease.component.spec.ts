...
describe('Desease Management Component', () => {
  let comp: DeseaseComponent;
  let fixture: ComponentFixture<DeseaseComponent>;
  let service: DeseaseService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'desease', component: DeseaseComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DeseaseComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.deseases?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
