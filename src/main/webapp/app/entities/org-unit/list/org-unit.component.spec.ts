...
describe('OrgUnit Management Component', () => {
  let comp: OrgUnitComponent;
  let fixture: ComponentFixture<OrgUnitComponent>;
  let service: OrgUnitService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'org-unit', component: OrgUnitComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(OrgUnitComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.orgUnits?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
